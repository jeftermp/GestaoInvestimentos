...
using XP.GestaoInvestimentos.Injector;

namespace XP.GestaoInvestimentos.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "XP.GestaoInvestimentos.API",
                        Version = "v1.0",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("v1/swagger.json", "XP.GestaoInvestimentos.API");
            });
